...
// Get active cases (approved appointments)
$active_cases = [];
try {
    $stmt = $pdo->prepare("SELECT a.*, c.full_name AS client_name, l.full_name AS lawyer_name 
                          FROM appointments a 
...
$user_counts = [
    ...
    'lawyers' => 0,
    'admins' => 0,
    'active_cases' => count($active_cases)
];
try {
...
<head>
    ...
    <style>
        ...
        .active-cases-table th,
        .active-cases-table td {
            padding: 12px;
            text-align: left;
...
<body>
    ...
    <main class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-number"><?php echo $user_counts['active_cases']; ?></div>
        ...
        <section class="card mt-3">
            <div class="card-header">
                ...
                <a href="admin_cases.php" class="btn">View All Cases</a>
            </div>
            <div class="cases-container">
                <table class="active-cases-table">
                    <thead>
                        <tr>
                            <th>Client</th>
                            <th>Lawyer</th>
                    ...
                    <tbody>
                        <?php if (!empty($active_cases)): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $case['lawyer_name'] ? htmlspecialchars($case['lawyer_name']) : 'Not Assigned'; ?></td>
                                <td><?php echo date('M d, Y', strtotime($case['appointment_date'])); ?></td>
                                <td><?php echo htmlspecialchars($case['legal_issue_type']); ?></td>
                                <td>
